...
public:
    ...
    ::Ice::Long PostUploadFile(const ::std::string& filename, ::Ice::Long filesize, const ::std::string& desc, const ::std::string& tag, const ::std::string& email, const ::std::string& sid, ::std::string& fetchurl)
    {
        return PostUploadFile(filename, filesize, desc, tag, email, sid, fetchurl, 0);
    }
    ::Ice::Long PostUploadFile(const ::std::string& filename, ::Ice::Long filesize, const ::std::string& desc, const ::std::string& tag, const ::std::string& email, const ::std::string& sid, ::std::string& fetchurl, const ::Ice::Context& __ctx)
    {
        return PostUploadFile(filename, filesize, desc, tag, email, sid, fetchurl, &__ctx);
    }
    
private:

    ::Ice::Long PostUploadFile(const ::std::string&, ::Ice::Long, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, ::std::string&, const ::Ice::Context*);
    
public:

    ::Ice::Long UsedSpaceSize(const ::std::string& email, const ::std::string& sid)
    {
        return UsedSpaceSize(email, sid, 0);
    }
    ::Ice::Long UsedSpaceSize(const ::std::string& email, const ::std::string& sid, const ::Ice::Context& __ctx)
    {
        return UsedSpaceSize(email, sid, &__ctx);
    }
    
private:

    ::Ice::Long UsedSpaceSize(const ::std::string&, const ::std::string&, const ::Ice::Context*);
...
public:
    ...
    ::std::string IsFileUploaded(const ::std::string& filename, ::Ice::Long filesize)
    {
        return IsFileUploaded(filename, filesize, 0);
    }
    ::std::string IsFileUploaded(const ::std::string& filename, ::Ice::Long filesize, const ::Ice::Context& __ctx)
    {
        return IsFileUploaded(filename, filesize, &__ctx);
    }
...
public:
    ...
    virtual ::Ice::Long PostUploadFile(const ::std::string&, ::Ice::Long, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, ::std::string&, const ::Ice::Context*) = 0;

    virtual ::Ice::Long UsedSpaceSize(const ::std::string&, const ::std::string&, const ::Ice::Context*) = 0;
...
public:
    ...
    virtual ::Ice::Long PostUploadFile(const ::std::string&, ::Ice::Long, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, ::std::string&, const ::Ice::Context*);

    virtual ::Ice::Long UsedSpaceSize(const ::std::string&, const ::std::string&, const ::Ice::Context*);
...
public:
    ...
    virtual ::Ice::Long PostUploadFile(const ::std::string&, ::Ice::Long, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, ::std::string&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___PostUploadFile(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual ::Ice::Long UsedSpaceSize(const ::std::string&, const ::std::string&, const ::Ice::Current& = ::Ice::Current()) = 0;
