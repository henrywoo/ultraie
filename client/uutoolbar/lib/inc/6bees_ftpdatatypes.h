...
namespace _6bees_socket{
  ...
  public:
    ...
    enum T_enFirewallType {
      ...
      bool operator!=(const CFirewallType& rhs) const{return m_enFirewallType!=rhs.AsEnum();}
      CFirewallType& operator=(const CFirewallType& rhs){
        m_enFirewallType = rhs.AsEnum();return *this;
      }
      ...
      static const CFirewallType UserRemoteIDatRemoteHostFireID(){
        return ftUserRemoteIDatRemoteHostFireID;
      }
      static const CFirewallType UserRemoteIDatFireIDatRemoteHost(){
        return ftUserRemoteIDatFireIDatRemoteHost;
      }
  private:
  ...
  public:
    ...
    CType(const CType& type):m_enType(type.AsEnum()){}
  ...
  public:
    ...
    bool operator!=(const CRepresentation& rep1) const {
      return rep1.m_Type!=m_Type || rep1.m_Format!=m_Format;
    }
    bool operator==(const CRepresentation& rep1) const {
      return rep1.m_Type == m_Type && rep1.m_Format == m_Format;
    }
  ...
  class CReply{
    ...
    public:
      ...
      bool IsPositiveReply() const {
        return IsPositivePreliminaryReply() ||
          IsPositiveCompletionReply() ||
          IsPositiveIntermediateReply();
      }
      bool IsNegativeReply() const {
        return IsTransientNegativeCompletionReply() ||
          IsPermanentNegativeCompletionReply();
      }
