#ifndef __UPLOADER_TITLETIP__
#define __UPLOADER_TITLETIP__
...
public:
	BOOL Create(HWND hWndParent){
		...
		m_rgbTextColour = (CTheme::IsThemingSupported()) ? GetSysColor( COLOR_WINDOWTEXT): GetSysColor( COLOR_INFOTEXT);		
	...
	LRESULT OnMouseRange( UINT nMessage, WPARAM wParam, LPARAM lParam , BOOL&)
	{
		SetMsgHandled( FALSE);
	...
	BOOL OnEraseBkgnd( UINT , WPARAM wParam, LPARAM lParam, BOOL&)
	{
		return TRUE;
	}
	
	LRESULT OnPaint( UINT , WPARAM wParam, LPARAM lParam, BOOL& )
	{
