...
CLogonInfo::CLogonInfo(const std::wstring& strHostname, unsigned short ushHostport, const std::wstring& strUsername, const std::wstring& strPassword, const std::wstring& strAccount) :
   ...
   m_FwType(CFirewallType::None())
{
   ...
   /*
CLogonInfo::CLogonInfo(const std::wstring& strHostname, unsigned short ushHostport, const std::wstring& strUsername, const std::wstring& strPassword,
   const std::wstring& strAccount, const std::wstring& strFwHostname, const std::wstring& strFwUsername, 
   const std::wstring& strFwPassword, unsigned short ushFwPort, const CFirewallType& crFwType) :
   m_strHostname(strHostname),
   m_ushHostport(ushHostport),
   m_strUsername(strUsername),
   m_strPassword(strPassword),
...
*/
void CLogonInfo::SetHost(const std::wstring& strHostname, unsigned short ushHostport, const std::wstring& strUsername, 
 const std::wstring& strPassword, const std::wstring& strAccount)
{
   m_strHostname  = strHostname;
   m_ushHostport  = ushHostport;
   m_strUsername  = strUsername;
...
void CLogonInfo::SetFirewall(const std::wstring& strFwHostname, const std::wstring& strFwUsername, const std::wstring& strFwPassword,
    unsigned short ushFwPort, const CFirewallType& crFwType)
{
   m_strFwHostname   = strFwHostname;
   m_strFwUsername   = strFwUsername;
   m_strFwPassword   = strFwPassword;
