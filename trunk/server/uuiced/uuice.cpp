...
::Ice::Long
IceProxy::UUTOOLBAR::User::PostUploadFile(const ::std::string& filename, ::Ice::Long filesize, const ::std::string& desc, const ::std::string& tag, const ::std::string& email, const ::std::string& sid, ::std::string& fetchurl, const ::Ice::Context* __ctx)
{
    int __cnt = 0;
    while(true)
    {
        ...
        try
        {
            ...
            __delBase = __getDelegate(false);
            ::IceDelegate::UUTOOLBAR::User* __del = dynamic_cast< ::IceDelegate::UUTOOLBAR::User*>(__delBase.get());
            return __del->PostUploadFile(filename, filesize, desc, tag, email, sid, fetchurl, __ctx);
        }
        catch(const ::IceInternal::LocalExceptionWrapper& __ex)
        {
            __handleExceptionWrapper(__delBase, __ex, 0);
...
::Ice::Long
IceProxy::UUTOOLBAR::User::UsedSpaceSize(const ::std::string& email, const ::std::string& sid, const ::Ice::Context* __ctx)
{
    int __cnt = 0;
    while(true)
    {
        ...
        try
        {
            ...
            __delBase = __getDelegate(false);
            ::IceDelegate::UUTOOLBAR::User* __del = dynamic_cast< ::IceDelegate::UUTOOLBAR::User*>(__delBase.get());
            return __del->UsedSpaceSize(email, sid, __ctx);
        }
        catch(const ::IceInternal::LocalExceptionWrapper& __ex)
        {
            __handleExceptionWrapper(__delBase, __ex, 0);
...
::std::string
IceProxy::UUTOOLBAR::User::IsFileUploaded(const ::std::string& filename, ::Ice::Long filesize, const ::Ice::Context* __ctx)
{
    int __cnt = 0;
    while(true)
    {
        ...
        try
        {
            ...
            __delBase = __getDelegate(false);
            ::IceDelegate::UUTOOLBAR::User* __del = dynamic_cast< ::IceDelegate::UUTOOLBAR::User*>(__delBase.get());
            return __del->IsFileUploaded(filename, filesize, __ctx);
        }
        catch(const ::IceInternal::LocalExceptionWrapper& __ex)
        {
            __handleExceptionWrapper(__delBase, __ex, 0);
...
::Ice::Long
IceDelegateM::UUTOOLBAR::User::PostUploadFile(const ::std::string& filename, ::Ice::Long filesize, const ::std::string& desc, const ::std::string& tag, const ::std::string& email, const ::std::string& sid, ::std::string& fetchurl, const ::Ice::Context* __context)
{
...
::Ice::Long
IceDelegateM::UUTOOLBAR::User::UsedSpaceSize(const ::std::string& email, const ::std::string& sid, const ::Ice::Context* __context)
{
...
::std::string
IceDelegateM::UUTOOLBAR::User::IsFileUploaded(const ::std::string& filename, ::Ice::Long filesize, const ::Ice::Context* __context)
{
...
::Ice::Long
IceDelegateD::UUTOOLBAR::User::PostUploadFile(const ::std::string& filename, ::Ice::Long filesize, const ::std::string& desc, const ::std::string& tag, const ::std::string& email, const ::std::string& sid, ::std::string& fetchurl, const ::Ice::Context* __context)
{
    class _DirectI : public ::IceInternal::Direct
    {
    public:

        _DirectI(::Ice::Long& __result, const ::std::string& filename, ::Ice::Long filesize, const ::std::string& desc, const ::std::string& tag, const ::std::string& email, const ::std::string& sid, ::std::string& fetchurl, const ::Ice::Current& __current) : 
            ::IceInternal::Direct(__current),
            _result(__result),
        ...
        run(::Ice::Object* object)
        {
            ...
            _result = servant->PostUploadFile(_m_filename, _m_filesize, _m_desc, _m_tag, _m_email, _m_sid, _m_fetchurl, _current);
            return ::Ice::DispatchOK;
        }
    ...
    try
    {
        _DirectI __direct(__result, filename, filesize, desc, tag, email, sid, fetchurl, __current);
        try
        {
            __direct.servant()->__collocDispatch(__direct);
        }
...
::Ice::Long
IceDelegateD::UUTOOLBAR::User::UsedSpaceSize(const ::std::string& email, const ::std::string& sid, const ::Ice::Context* __context)
{
    class _DirectI : public ::IceInternal::Direct
    {
    public:

        _DirectI(::Ice::Long& __result, const ::std::string& email, const ::std::string& sid, const ::Ice::Current& __current) : 
            ::IceInternal::Direct(__current),
            _result(__result),
            _m_email(email),
            _m_sid(sid)
        ...
        run(::Ice::Object* object)
        {
            ...
            _result = servant->UsedSpaceSize(_m_email, _m_sid, _current);
            return ::Ice::DispatchOK;
        }
    ...
    try
    {
        _DirectI __direct(__result, email, sid, __current);
        try
        {
            __direct.servant()->__collocDispatch(__direct);
        }
...
::std::string
IceDelegateD::UUTOOLBAR::User::IsFileUploaded(const ::std::string& filename, ::Ice::Long filesize, const ::Ice::Context* __context)
{
    class _DirectI : public ::IceInternal::Direct
    {
    public:

        _DirectI(::std::string& __result, const ::std::string& filename, ::Ice::Long filesize, const ::Ice::Current& __current) : 
            ::IceInternal::Direct(__current),
            _result(__result),
            _m_filename(filename),
            _m_filesize(filesize)
        ...
        run(::Ice::Object* object)
        {
            ...
            _result = servant->IsFileUploaded(_m_filename, _m_filesize, _current);
            return ::Ice::DispatchOK;
        }
    ...
    try
    {
        _DirectI __direct(__result, filename, filesize, __current);
        try
        {
            __direct.servant()->__collocDispatch(__direct);
        }
...
UUTOOLBAR::User::___PostUploadFile(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    ...
    ::IceInternal::BasicStream* __os = __inS.os();
    ::std::string fetchurl;
    ::Ice::Long __ret = PostUploadFile(filename, filesize, desc, tag, email, sid, fetchurl, __current);
    __os->write(fetchurl);
    __os->write(__ret);
    return ::Ice::DispatchOK;
}
...
UUTOOLBAR::User::___UsedSpaceSize(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    ...
    __is->endReadEncaps();
    ::IceInternal::BasicStream* __os = __inS.os();
    ::Ice::Long __ret = UsedSpaceSize(email, sid, __current);
    __os->write(__ret);
    return ::Ice::DispatchOK;
}
...
UUTOOLBAR::User::___IsFileUploaded(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    ...
    __is->endReadEncaps();
    ::IceInternal::BasicStream* __os = __inS.os();
    ::std::string __ret = IsFileUploaded(filename, filesize, __current);
    __os->write(__ret);
    return ::Ice::DispatchOK;
}
...
{
    ::std::pair< ::std::string*, ::std::string*> r = ::std::equal_range(__UUTOOLBAR__User_all, __UUTOOLBAR__User_all + 21, current.operation);
    if(r.first == r.second)
    {
